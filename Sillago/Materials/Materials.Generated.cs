...
public partial class Materials
{
    ...
    public static Material Polytetrafluoroethylene = new IngotMaterial(
        "Polytetrafluoroethylene",
        0xEEEEEE,
        VisualSet.Dull,
        new Compound(Element.C * 2, Element.F * 4).Polymer(),
        MaterialFlags.ThermallyInsulating,
        density: 2200f,
        meltingPoint: 327f);
    ...
    public static Material Fluoride = new PowderMaterial(
        "Fluoride",
        0xFDFFE8,
        VisualSet.Default,
        Element.F,
    ...
    public static Material HydrogenFluoride = new FluidMaterial(
        "Hydrogen Fluoride",
        0xF3FFF4,
        VisualSet.Shiny,
        ...
        density: 991f,
        freezingPoint: -83.6f,
        vaporisationPoint: 19.5f);
    
    public static Material Trichloromethane = new FluidMaterial(
        "Trichloromethane",
        0xD3C4C4,
        VisualSet.Shiny,
        new Compound(Element.C * 1, Element.H * 1, Element.Cl * 3),
        MaterialFlags.Toxic,
        density: 1489f,
        freezingPoint: -63.5f,
        vaporisationPoint: 61.2f);
    
    public static Material HydrogenChloride = new FluidMaterial(
        "Hydrogen Chloride",
        0xCCEEFF,
        VisualSet.Default,
        new Compound(Element.H * 1, Element.Cl * 1),
        MaterialFlags.Corrosive | MaterialFlags.Toxic,
        density: 1627f,
        freezingPoint: -114.2f,
        vaporisationPoint: -85.05f);
    
    public static Material Chlorotrifluoromethane = new FluidMaterial(
        "Chlorotrifluoromethane",
        0xAADDEE,
        VisualSet.Default,
        new Compound(Element.C * 1, Element.H * 1, Element.Cl * 1, Element.F * 3),
        MaterialFlags.Toxic,
        density: 1220f,
        freezingPoint: -160.8f,
        vaporisationPoint: -40.8f);
    
    public static Material Tetrafluoroethylene = new FluidMaterial(
        "Tetrafluoroethylene",
        0x99EEFF,
        VisualSet.Default,
        new Compound(Element.C * 2, Element.F * 4),
        MaterialFlags.Flammable | MaterialFlags.Toxic,
        density: 4460f,
        freezingPoint: -140f,
        vaporisationPoint: -76.3f);
    
    public static Material Chlorine = new FluidMaterial(
        "Chlorine",
        0x99FF99,
        VisualSet.Default,
        new Compound(Element.Cl * 2),
        MaterialFlags.Toxic | MaterialFlags.Corrosive,
        density: 3200f,
