namespace Sillago.Tests
{
    ...
    public class RecipeTests
    {
        ...
        {
            Recipe recipe = CreateSampleRecipeWithRequirements(Array.Empty<IRecipeRequirement>());
        ...
        public void AreRequirementsMet_AllRequirementsMet_ReturnsTrue()
        {
            ...
            Recipe recipe = this.CreateSampleRecipeWithRequirements(new[] { req1, req2 });
            DummyMachine machine = new();
        ...
        public void GetInfo_IncludesAllDetails()
        {
            ...
            Recipe recipe = new(
                ...
                "Test Recipe",
                SampleRecipeType,
                new List<RecipeIngredient> { RecipeIngredient.Of(itemInput) },
                new List<RecipeResult> { RecipeResult.Of(itemOutput) },
                new List<IRecipeRequirement> { req1, req2 },
        ...
        public void AreInputsAvailable_InputsAvailableAlternate_ReturnsTrue()
        {
            ...
            RecipeIngredient ingredient = RecipeIngredient.AnyOf(new List<ItemStack> { itemA.Stack(2), itemB.Stack(3) });
            Recipe recipe = new(
                "test_id",
                "Test Recipe",
                this.SampleRecipeType,
        ...
        public void ConsumeInputs_HandlesAlternatesInput_RemovesFromInventory()
        {
            ...
            RecipeIngredient ingredient1 = RecipeIngredient.AnyOf(new List<ItemStack> { itemA.Stack(2), itemB.Stack(3) });
            Recipe recipe = new(
                "test_id",
                "Test Recipe",
                this.SampleRecipeType,
